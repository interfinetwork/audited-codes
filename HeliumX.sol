...
HELIUMX (HEX) TOKEN aims is built strong foundation in crypto markets also in the real world by building a successful
Food processing business in Africa and the profit we will share to the Holders.

Telegram: https://t.me/hexheliumx24
Website: https://www.heliumx.org
...
contract HELIUMX is ERC20, Ownable{
    ...
    Taxes public taxes = Taxes(6, 3, 1, 1, 3, 1);
    Taxes public sellTaxes = Taxes(6, 3, 1, 1, 4, 1);
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {
        ...
        //calculate fee
            ...
            feeswap = sellTaxes.liquidity + sellTaxes.marketing + sellTaxes.dev + sellTaxes.charity + sellTaxes.buyback;
            feesum = feeswap + sellTaxes.lottery;
            currentTaxes = sellTaxes;
        }
        else{
            feeswap =  taxes.liquidity + taxes.marketing + taxes.dev + taxes.charity + taxes.buyback;
