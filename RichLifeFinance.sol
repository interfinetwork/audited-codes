...
contract RichLifeFinance is ERC20Detailed, Ownable {
    ...
    string public _name = "RichLife Finance";
    string public _symbol = "RLF";
    ...
    uint256 public rlfBankFee = 20;
    uint256 public nftHolderFee = 20;

    uint256 public sellFee = rlfBankFee.add(nftHolderFee);
    ...
    address public rlfBankReceiver;
    ...
    constructor() ERC20Detailed("RichLife Finance", "RLF", uint8(DECIMALS)) Ownable() {
        ...
        lpReceiver = 0x40528866ce889166C7C9fD5012A194B56477Be93;
        treasuryReceiver = 0x99F93e6933fD89c08441750e50894603839b33B4;
        insuranceReceiver = 0x1Ce9c1a88780448920073a4B39627D38A3dbE9C1;
        rlfBankReceiver = 0x8d667a2C79dE0Fe64EfC62B56fabe25b0E98Cf4c;
        nftHolderReceiver = 0x03C418FFcc829F1Ee1f00a9FD94DD86c88A3bc45;
    ...
    function setNormalFees() external onlyOwner {
        ...
        sellFee = rlfBankFee.add(nftHolderFee);
    ...
    function swapBack() internal swapping {
        ...
        uint256 _currentFee = treasuryFee.add(insuranceFee).add(rlfBankFee).add(nftHolderFee);
        ...
        (success, ) = payable(rlfBankReceiver).call{
        value: currentBalance.mul(rlfBankFee).div(
            _currentFee
        ),
        gas: 30000
        }("");
