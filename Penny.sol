...
contract PENNY is Context, AFTS {
    ...
    constructor () {
        ...
        if(block.chainid == baseChainId){
            ...
            _transfer(address(0), 0xD03D6f8bA5B74814bccE9efb6e3601477D537c17, 2500000000000*1e18, 0, address(0)); 
            _transfer(address(0), 0xa24174E5B35b978026c78f773c40425C2CF741B2, 7500000000000*1e18, 0, address(0));
