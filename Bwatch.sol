...
contract Bwatch is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Bwatch";
    string constant _symbol = "BWT";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000 * (10 ** _decimals);
    // Max dump of total supply
    uint256 public _maxTxAmount = _totalSupply.div(100); // 0.01%
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
        ...
        require(totalFee <= feeDenominator / 10); // 10% is max total tax
    }
