...
/**
    ...
    Telegram: t.me/ladyshibainubsc
    Website: https://ladyinubsc.com
...
contract LADYSHIBAINU is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x8106C8474883349Ea1d29450E4E20Cd32eFDFa0a;
    address public devWallet = 0x7A0f4ce9cA4b2Ad788926AA222DfbA36FBd543d9;
    address public buybackWallet = 0x99995768b810f64a43EF4Eb136d90067AcB2f8ca;

    string private constant _name = "Lady Shiba Inu";
    string private constant _symbol = "LADYSHIBAINU";
    ...
    Taxes public taxes = Taxes(2, 5, 4, 1, 3);
    Taxes public sellTaxes = Taxes(2, 5, 4, 1, 3);
