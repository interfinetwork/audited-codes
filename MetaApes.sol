...
contract MetaApesBSC is Context, IERC20, Auth {
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = 'MetaApes';
    string private constant _symbol = 'MetaApes';
    ...
    uint256 public _asT = 40000000 * (10 ** _decimals);
    ...
    uint256 public sT = 100000000 * (10 ** _decimals);
    bool LFG = false;
