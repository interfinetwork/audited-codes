...
/*
       ...
       ____   _____   ____   ___    _  __   ____        __  ___   ____   _  __   ____   ___ 
      / __ \ / ___/  / __/  / _ |  / |/ /  / __/       /  |/  /  /  _/  / |/ /  / __/  / _ \
     / /_/ // /__   / _/   / __ | /    /  _\ \        / /|_/ /  _/ /   /    /  / _/   / , _/
     \____/ \___/  /___/  /_/ |_|/_/|_/  /___/       /_/  /_/  /___/  /_/|_/  /___/  /_/|_| 
...
contract MoceansDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() DividendPayingToken("MOCEANS_Tracker", "MO_Tracker", _rewardTokenAddress) {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 10 * (10 ** 18); 
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "MOCEANS_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "MOCEANS_Tracker: withdrawDividend disabled. Use the 'claim' function on the main contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "MOCEANSToken_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "MOCEANSToken_Dividend_Tracker: Cannot update claimWait to same value");
...
contract MOCEANS is ERC20, Ownable {
    ...
    MoceansDividendTracker public dividendTracker;
    ...
    address public _marketingWalletAddress = 0x2cbf052439fF7A38672bB783B8B208fC98AA23a3;
    address public _gasFeeCollector = 0x639051710d4fa6CF765E3F645B3cF4D170814BE8;
    ...
    constructor() ERC20("Oceans Miner", "MOCEANS")  {
        ...
        dividendTracker = new MoceansDividendTracker();
