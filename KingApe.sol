...
contract KINGAPE is Context, IERC20 {
    ...
    string constant private _name = "KING APE";
    string constant private _symbol = "KINGAPE";
    ...
    address payable private _marketingWallet = payable(0x81561CB742F31d82f4fB309e0C82703828479be8);
    address payable private _charityWallet = payable(0x35Ea7D043CA5a3a72660fD5c7ea42b18BA3A0333);
    address payable private _developmentWallet = payable(0x4b7FF36f07972d77d94ddF6fc0FBe7ADba4ade84);
...
//===============================================================================================================
    ...
    function setRatios(uint16 marketing, uint16 charity, uint16 development) external onlyOwner {
        _ratios.marketing = marketing;
        _ratios.charity = charity;
        _ratios.development = development;
        _ratios.total = marketing + charity + development;
    }
    ...
    function setWallets(address payable marketingWallet, address payable charityWallet, address payable developmentWallet) external onlyOwner {
    ...
    function contractSwap(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if (address(this).balance > 0) {
            _marketingWallet.transfer((currentETH * _ratios.marketing) / _ratios.total);
            _charityWallet.transfer((currentETH * _ratios.charity) / _ratios.total);
