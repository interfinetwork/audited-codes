...
contract CBBSC is IBEP20, Auth {
    ...
    string constant _name = "Central Bank Of Binance Smart Chain";
    string constant _symbol = "CBBSC";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x4604775dcCC4cf3EaE9b49236A6d41d3D038939C;
        teamFeeReceiver = 0xA9EB7A7Bc034737a913425396c9A7a96cB5Fd210;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(!authorizations[sender] && !authorizations[recipient]){
            ...
            if(launchMode && antibot && sender == pair){
                require(isBlacklisted[recipient] || balanceOf(recipient) == 0);
    ...
    function setMultipliers(uint256 _buy, uint256 _sell, uint256 _trans) external authorized {
        ...
        require(totalFee.mul(buyMultiplier).div(100) < 32, "Tax cannot be more than 32%");
        require(totalFee.mul(sellMultiplier).div(100) < 32, "Tax cannot be more than 32%");
    }
