...
$WISP The First High Yield Auto-Staking + Compounding protocol on #Avalanche
that actually burns!

the World's First & Highest Yielding AutoStaking + AutoCompounding Protocol 
on #Avalanche  that TRULY burns to the 0x000dEaD address, rather than a wallet the devs 
can dump with.
Wisp boasts one of the Highest fixed APYs in Crypto; 508,707.77% for the first 12 months.

🔺 Learn more about $WISP by following our socials:
...
contract Wisp is ERC20Detailed, Ownable {
    ...
    string public _name = "Wisp";
    string public _symbol = "WISP";
    ...
    constructor() ERC20Detailed("Wisp", "WISP", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x24D6Bd1EFCb7dAb015434BD2a28fe8139e33E720;
        treasuryReceiver = 0xdc7f56b4841948161FE9e0913c8722BC493b09A7; 
        wispVaultReceiver = 0xeC3468bCD879f536dA939Ba199497faEc2f0EAbF;
        firePit = DEAD;
