...
contract ARN is IERC20, Ownable {
    ...
    string constant _name = "AntiRugN";
    string constant _symbol = "ARN";
    ...
    constructor() {
        ...
        address deployer = 0x0C2B22794FE5e74275FF0453BCc7FacAA83dc8F5;

        isFeeExempt[deployer] = true;

        isAuthorized[deployer] = true;
        devFeeReceiver = 0xc0976e73A93BCF421b4243F3D0365C87aC8a2d51;
    ...
    function updateSwapPercentages(uint256 dev, uint256 liquidity)
        public
        onlyOwner
    {
        devSwap = dev;
        liquiditySwap = liquidity;
        totalSwap = dev.add(liquidity);
    }
    ...
    function swapBackInBnb() internal swapping {
        ...
        if (swappedBnbAmount > 0) {
            (bool marketingSuccess, ) = payable(devFeeReceiver).call{
