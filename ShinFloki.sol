...
/**
    ...
    Telegram: https://t.me/shinflokibsc
    Website: https://shinfloki.finance
...
contract SHINFLOKI is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 1_500_000 * 10**9;
    uint256 public maxSellLimit = 500_000 * 10**9;
    uint256 public maxWalletLimit = 3_000_000 * 10**9;

    uint256 public genesis_block;
    uint256 private deadline;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x40552636f7688A59344918808655A99dCdc6A056;
    address public devWallet = 0x9aEEB2BDeEf23D223Acd7Be73856bAaA730d60D9;

    string private constant _name = "ShinFloki";
    string private constant _symbol = "SHINFLOKI";
    ...
    Taxes public taxes = Taxes(2, 6, 3, 1);
    Taxes public sellTaxes = Taxes(2, 6, 3, 1);
