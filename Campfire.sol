...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
    ...
    address public adminAddress = 0x055bfF51985521E7DA12c7B6D2CcF98a66f9EE4D; //contract wallet
...
contract Campfire is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Campfire", "CAMPFIRE") {
        a80DividendTracker = new A80DividendTracker();
        b20DividendTracker = new B20DividendTracker();
        
        contractWallet = 0x055bfF51985521E7DA12c7B6D2CcF98a66f9EE4D;
        marketingWallet = 0x05B63f802E63f3451cEBCC2a586c82D51aF3fA63;
...
contract A80DividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("A80_Dividend_Tracker", "A80_Dividend_Tracker", 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c, tx.origin) {
        claimWait = 3600;
...
contract B20DividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("B20_Dividend_Tracker", "B20_Dividend_Tracker", 0x2170Ed0880ac9A755fd29B2688956BD959F933F8, tx.origin) {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 10000+ tokens
    }
