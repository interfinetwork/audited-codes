...
interface ICROMetadata is ICRO {
    /**
...
contract CRO is Context, ICRO, ICROMetadata {
     ...
     * Ether and Wei. This is the value {CRO} uses, unless this function is
     * overridden;
     *
     * NOTE: This information is only used for _display_ purposes: it in
     * no way affects any of the arithmetic of the contract, including
     * {ICRO-balanceOf} and {ICRO-transfer}.
     */
    ...
    /**
     * @dev See {ICRO-transferFrom}.
     *
     * Emits an {Approval} event indicating the updated allowance. This is not
     * required by the EIP. See the note at the beginning of {CRO}.
     *
     * Requirements:
     *
    ...
    function transferFrom(
        ...
        require(currentAllowance >= amount, "CRO: transfer amount exceeds allowance");
     ...
     * problems described in {ICRO-approve}.
     *
        ...
        returns (bool)
    {
        ...
        require(currentAllowance >= subtractedValue, "CRO: decreased allowance below zero");
    ...
    function _transfer(
        ...
        require(sender != address(0), "CRO: transfer from the zero address");
        require(recipient != address(0), "CRO: transfer to the zero address");

        _beforeTokenTransfer(sender, recipient, amount);

        uint256 senderBalance = _balances[sender];
        require(senderBalance >= amount, "CRO: transfer amount exceeds balance");
    ...
    function _tokengeneration(address account, uint256 amount) internal virtual {
        require(account != address(0), "CRO: generation to the zero address");
    ...
    function _burn(address account, uint256 amount) internal virtual {
        require(account != address(0), "CRO: burn from the zero address");

        _beforeTokenTransfer(account, address(0), amount);

        uint256 accountBalance = _balances[account];
        require(accountBalance >= amount, "CRO: burn amount exceeds balance");
    ...
    function _approve(
        ...
        require(owner != address(0), "CRO: approve from the zero address");
        require(spender != address(0), "CRO: approve to the zero address");
...
contract CROLONMARS is CRO, Ownable {
    ...
    constructor(address routerAdd) CRO("Crolon Mars", "CLMRS") {
    ...
    function rescueCROtokens(address tokenAdd, uint256 amount) external onlyOwner {
        ICRO(tokenAdd).transfer(devWallet, amount);
    }
