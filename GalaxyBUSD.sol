...
contract GalaxyBUSD is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public marketingWallet = address(0x00f012B0A73284E646c4196F5fbfE81Be599Ed2f); //marketing wallet
    address public developmentWallet = address(0x3fBaA1da2488ABe11cbE9E8f44168C82B2095655); //development wallet

    uint16 public transferRewardsFee = 50;
    uint16 public transferLiquidityFee = 50;
    uint16 public transferMarketingFee = 25;
    uint16 public transferDevelopmentFee = 50;
    uint16 public transferBuybackFee = 25;
    uint16 private totalTransferFee = 200; // 2% Transfer fee

    uint16 public rewardsFee = 800; // 8% fee
    uint16 public liquidityFee = 300; // 3% fee
    uint16 public marketingFee = 100; // 1% fee
    uint16 public developmentFee = 100; // 1% fee
    uint16 public buybackFee = 200; // 2% fee
    ...
    constructor() ERC20("GalaxyBUSD", "GALAXY") {
...
contract TOKENDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("Galaxy_Dividend_Tracker", "Galaxy_Dividend_Tracker")
    {
        claimWait = 3600;
