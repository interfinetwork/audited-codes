 ...
 *                
 *                  Kimetsu Sensei
 *       Fees on Buy: 15% / Fees on Sell: 15%
 * 10% Rewards 2% Liquidity 3% Marketing 0% Extra Sell Fee
 *                          
 * 
 *              https://t.me/InuSensei
 * 
 * 
*/
...
contract KimetsuSensei is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Kimetsu Sensei";
    ...
    uint256 _totalSupply = 1 * 10**9 / 4 * (10 ** _decimals);
    ...
    uint256 public liquidityFee = 2; //buy and sell tax
    uint256 public marketingFee = 3; //buy and sell tax
    uint256 public rewardsFee = 10; //buy and sell tax
    uint256 public extrasellFee = 0; //additional sell tax

    uint256 public totalFee = 0; // buy and sell tax total
    uint256 public totalFeeIfSelling = 0; //buy and sell plus extra sell total

    address public autoLiquidityReceiver;
    address public marketingWallet;
    address public extrasellWallet;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x07997108B7973f1F3065586D98a24949d815BA9C;  // marketingwallet
        extrasellWallet = 0x9eeA76fe500f372595CaAa04af758Ef0166e0Ae5;  // extrasellwallet
        
        totalFee = liquidityFee.add(marketingFee).add(rewardsFee);
        totalFeeIfSelling = totalFee.add(extrasellFee);
    ...
    function changeFees(uint256 newLiqFee, uint256 newRewardFee, uint256 newMarketingFee, uint256 newExtraSellFee) external authorized {
        ...
        extrasellFee = newExtraSellFee;
        
        totalFee = liquidityFee.add(marketingFee).add(rewardsFee);
        totalFeeIfSelling = totalFee.add(extrasellFee);
    }

    function changeFeeReceivers(address newLiquidityReceiver, address newMarketingWallet, address newExtraSellWallet) external authorized {
        autoLiquidityReceiver = newLiquidityReceiver;
        marketingWallet = newMarketingWallet;
        extrasellWallet = newExtraSellWallet;
    }
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 amountBNBExtraSell = amountBNB.mul(extrasellFee).div(totalBNBFee);
        ...
        (bool tmpSuccess1,) = payable(extrasellWallet).call{value: amountBNBExtraSell, gas: 30000}("");
