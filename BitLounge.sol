...
contract Placeholder is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Bit Token";
    string constant _symbol = "BT";
    ...
    uint256 totalFee = liquidityFee+reflectionFee+marketingFee; // 5% + 5% + 5%
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x936b1bFE9aFa926649489BA77b916aDc7111b594;
