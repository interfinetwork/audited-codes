...
contract PNFT is BEP20 {
    ...
    constructor(address ownerAddress) BEP20("PNFT", "PNFT", 18) public {
        owner = ownerAddress;
        _mint(owner, 900000000000*1e18);
    }

    function mint(address account, uint256 amount) onlyOwner public {
        require(amount > 0, "BEP20: amount should be valid");
