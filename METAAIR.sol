/**
    ...
    🐦 Twitter: https://twitter.com/metaaircoin
...
contract METAAIR is ERC20, Ownable {
    ...
    MetaAirDividendTracker public dividendTracker;

    address public constant deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x17Cc657Ad0917CAcbba0c37683269077Acc6F81C;
    address public operationsWallet = 0x14a05D2d6096B2059332DCD08B37A7f47367c598;
    address public buybackWallet = 0xB3aFb8569a83bA77399012406f34F75A2D41fC31;
    address public devWallet = 0x0E85963d7851eaE6e8D8d4329259Ad10A85B3A3E;

    uint256 public swapTokensAtAmount = 1_000_000 * 10**9;
    uint256 public maxWalletBalance = 20_000_000 * 10**9;
    uint256 public maxBuyAmount = 10_000_000 * 10**9;
    uint256 public maxSellAmount = 5_000_000 * 10**9;
    ...
    Taxes public buyTaxes = Taxes(3,3,1,1,2,2);
    Taxes public sellTaxes = Taxes(3,3,1,1,2,2);
    ...
    uint256 public coolDownBalance = 5000000 * 10**9;
    ...
    constructor() ERC20("MetaAir", "MAIR") {

    	dividendTracker = new MetaAirDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        MetaAirDividendTracker newDividendTracker = MetaAirDividendTracker(payable(newAddress));
   ...
   /////////////////////////////////
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "MetaAir: Account is already the value of 'excluded'");
   ...
   ///////////////////////
    ...
    function setBuyTaxes(uint256 _rewards, uint256 _marketing, uint256 _liquidity, uint256 _operations, uint256 _buyback, uint256 _dev) external onlyOwner{
        buyTaxes = Taxes(_rewards, _marketing, _liquidity, _operations, _buyback, _dev);
    }

    function setSellTaxes(uint256 _rewards, uint256 _marketing, uint256 _liquidity,uint256 _operations,uint256 _buyback, uint256 _dev) external onlyOwner{
    ...
    function _setAutomatedMarketMakerPair(address newPair, bool value) private {
        require(automatedMarketMakerPairs[newPair] != value, "MetaAir: Automated market maker pair is already set to that value");
    ...
    function setGasForProcessing(uint256 newValue) external onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "MetaAir: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "MetaAir: Cannot update gasForProcessing to same value");
   ...
   ////////////////////////
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        uint256 swapTax = sellTaxes.rewards + sellTaxes.marketing + sellTaxes.liquidity + sellTaxes.operations + sellTaxes.buyback + sellTaxes.dev;
        ...
        if(takeFee) {
            ...
            if(automatedMarketMakerPairs[to]){
                ...
                swapAmt = amount * (buyTaxes.rewards + buyTaxes.marketing + buyTaxes.liquidity + buyTaxes.operations + buyTaxes.buyback + buyTaxes.dev) / 100;
            }
...
contract MetaAirDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()  DividendPayingToken("MetaAir_Dividen_Tracker", "MetaAir_Dividend_Tracker") {
    	claimWait = 3600;
    	minimumTokenBalanceForDividends = 11 * (10**decimals()); 
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "MetaAir_Dividend_Tracker: No transfers allowed");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "MetaAir_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "MetaAir_Dividend_Tracker: Cannot update claimWait to same value");
