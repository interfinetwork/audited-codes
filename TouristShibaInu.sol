...
/*
    ...
    Telegram:   https://t.me/TouristShibaInu

    Twitter:    https://twitter.com/TouristShibaInu

    Website:    https://touristshibainu.com/
...
contract TOURISTSHIBAINU is Context, IBEP20, LockToken {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x8960CaBA58320eBDCBC2037b7ed9346447fB11EE); // Marketing Address
    ...
    string private _name = "TOURIST SHIBA INU";
    string private _symbol = "TOURISTS";
    ...
    uint256 public _maxTxAmount = 1_000_000_000_000 * 10**9; //1%
    uint256 private minimumTokensBeforeSwap = 10_000_000 * 10**9; //10 Millian
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        uint256 swapableFee = _liquidityFee.add(_marketingFee);
        ...
        uint256 newBlance = address(this).balance.sub(initialBalance);
        uint256 bnbForLiquidity =  newBlance.mul(_liquidityFee).div(swapableFee).div(2);
        ...
        transferToAddressETH(marketingAddress, newBlance.sub(bnbForLiquidity));
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        ...
        if(burnTokens>0) { _transferStandard(sender, deadAddress, burnTokens); }
        restoreAllFee();
    }
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _burnFee = 0;
        _previousBurnFee = _burnFee;
        _maxTxAmount = 100_000_000_000_000 * 10**9;
    }
...
//////------------  ANTI WHALE ---------------////////////
    ...
    uint256 public maxLimit =  _tTotal.div(100).mul(2); //2% max wallet limit
    ...
    private view
    {
        ...
        if(to==uniswapV2Pair && !_isExcludedFromWhale[to]) 
        { 
            require(newBalance <= maxLimit, "Exceeding max tokens limit in the wallet"); 
        } 
    }
