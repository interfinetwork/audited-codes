...
interface IRouter {
    ...
    contract PandaElon is ERC20, Ownable {
    ...
    address private marketingWallet = 0x5C310B3F82cb8eBFf86080B9D2D7e332AD85b115;
    address private devWallet = 0x09c2B0151820b958789215c0A699321E33FfB06c;
    ...
    Taxes public taxes = Taxes(4, 2, 2);
    Taxes public sellTaxes = Taxes(4, 2, 2);
    ...
    constructor(address routerAdd) ERC20("Panda Elon", "PELON") {
        _tokengeneration(msg.sender, 1e9 * 10**decimals());
        exemptFee[msg.sender] = true;

        IRouter _router = IRouter(routerAdd);
        // Create a pcs pair for this new token
    ...
    function swapTokensForETH(uint256 tokenAmount) private {
        // generate the pcs pair path of token -> weth
