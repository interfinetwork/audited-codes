...
//Telegram: https://t.me/sacreddoge
...
contract SacredDoge is Context, IERC20 {
    ...
    uint256 private startingSupply = 1_600_000_000;

    string constant private _name = "Sacred Doge";
    string constant private _symbol = "SDOGE";
    ...
    address payable private _marketingWallet = payable(0x40af0eDC3A1174E00aEE71e9199D5d085dfb669D);
    address payable private _teamWallet = payable(0x40af0eDC3A1174E00aEE71e9199D5d085dfb669D);
...
//===============================================================================================================
    ...
    function setRatios(uint16 liquidity, uint16 marketing, uint16 team) external onlyOwner {
        require (liquidity + team + marketing >= 99, "Must add up to 100% or 99%.");
    ...
    Balances public __balances = Balances({
        market: 0,
        liquidity: 0,
        team: 0
        });
