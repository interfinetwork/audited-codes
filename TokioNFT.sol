...
contract TOKIONFT is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x970fd90F4E948DBBbB04e83ec8bE3A998e084d6B); // Marketing Address
    ...
    string private _name = "TOKIONFT";
    string private _symbol = "RAMPAGE";
