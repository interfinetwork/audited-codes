...
contract SquidVerse3D is IBEP20, Ownable {
    ...
    string private constant _symbol = "SVerse3D";
    uint8 private constant _decimals = 18;
    uint public constant TOTAL_SUPPLY = 10**6 * 10**_decimals;     // 1,000,000
    ...
    uint256 public _maxTokensToBuySell = 10**2 * 10**18;   			// 0.01%
