...
contract Analytica is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 3_000_000_000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    address public investmentWallet;

    string private _name = "Analytica";
    string private _symbol = "ALT";
    uint8 private _decimals = 9;

    uint256 public investmentFeePercent = 6;
    ...
    uint256 public _maxTxAmount = 150000000 * 10**9; // 5%
    uint256 public numTokensSellToAddToLiquidity = 3_000_000_000 * 10**9;
    ...
    function setInvestmentFeePercent(uint256 fee) public onlyOwner {
        require(fee < 50, "Investment fee cannot be more than 50% of liquidity");
        investmentFeePercent = fee;
    }

    function setInvestmentWallet(address walletAddress) public onlyOwner {
        investmentWallet = walletAddress;
    }
    ...
    function claimTokens () public onlyOwner {
        // make sure we capture all ALT that may or may not be sent to this contract
        payable(investmentWallet).transfer(address(this).balance);
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 investmentshare = newBalance.mul(investmentFeePercent).div(100);
        payable(investmentWallet).transfer(investmentshare);
        newBalance -= investmentshare;
