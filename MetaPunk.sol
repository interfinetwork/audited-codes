...
contract METAPUNK is IERC20Metadata, Ownable {
    ...
    address public marketingWallet = 0x391a90777dF6e19dfF47E8D26e9Cb90D22477AB6;
    address public devWallet = 0x71eE5cb894e499fD86f44C8F9D83A3d926ae5263;
    address private teamWallet = 0xc23722208CFE82982c92FC509420fF0Cb924d9bC;
    
    string constant _name = "METAPUNK";
    string constant _symbol = "MTPK";
    uint8 constant _decimals = 18;
    
    uint256 private constant MAX = ~uint256(0);
    uint256 internal constant _totalSupply = 5000000000 * (10**18);
    ...
    uint256 public devFee = 30; // 3%
    uint256 private teamFee = 20; // 2%
    ...
    uint256 private teamPortionOfSwap = 150; // 15%
