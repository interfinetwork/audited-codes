...
contract Bobatama is Context, IERC20, Ownable {
    ...
    uint256 public maxSellLimit = 10_000_000_000 * 10**9;
    uint256 public maxWalletLimit = 30_000_000_000 * 10**9;

    uint256 public genesis_block;
    uint256 private deadline;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x4579dd0cF46a192f71fd1be3F5843139E5c67F5c;
    address public devWallet = 0xE930f7d278ae019675146a770Ea1EA5Df3f81E9D;
    address public opsWallet = 0xD2c75EdB85b75FD5620e5E1Be461425fEd3D63c4;
    ...
    Taxes public taxes = Taxes(2, 5, 2, 1, 2);
    Taxes public sellTaxes = Taxes(2, 5, 2, 1, 2);
    ...
    function setTradingStatus(
        ...
        swapEnabled = state;
        deadline = _deadline;
        launchtax = Taxes(rfi, marketing, liquidity, dev, ops);
    ...
    function setTaxes(
        ...
        taxes = Taxes(_rfi, _marketing, _liquidity, _dev, _ops);
        emit FeesChanged();
    }
    ...
    function setSellTaxes(
        ...
        sellTaxes = Taxes(_rfi, _marketing, _liquidity, _dev, _ops);
        emit FeesChanged();
    }
