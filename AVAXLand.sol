...
contract AvaxLand is ERC20, Ownable {
    ...
    address internal constant avariceTeam_addr = 0x6674393a1314D9037345efFe38a5c6bd90632f81; // 39%
    address internal marketing_addr = 0xaF83e4aF087476658138208DDf11146ba6Ee32b5;
    address internal buyBack_addr = 0x7DDe3D57f09411e2E3262F3E24AE5E33795D1421;
    ...
    uint256 internal constant bonus_calc_ratio = 384;  
    ...
    function flushFirstDayLobbyEntry() external onlyOwner() nonReentrant {
        ...
        payable(avariceTeam_addr).transfer((lobbyEntry[1] * 93) /100);  
    }
    ...
    function calcBonusToken (uint256 StakeDuration, uint256 StakeAmount) public pure returns (uint256) {
        ...
        uint256 _bonusAmount = StakeAmount * ((StakeDuration ** 5).sqrrt()) * bonus_calc_ratio;
