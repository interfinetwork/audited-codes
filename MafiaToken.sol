...
contract MafiaToken is ERC20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        isFeeExempt[MobBankFeeReceiver] = true;
        isFeeExempt[marketingFeeReceiver] = true;
    
        isTxLimitExempt[msg.sender] = true;
        isTxLimitExempt[pair] = true;
        isTxLimitExempt[MobBankFeeReceiver] = true;
        isTxLimitExempt[marketingFeeReceiver] = true;


        autoLiquidityReceiver = msg.sender;
        marketingFeeReceiver = 0x94B6E80E388E1567330992334897AB2d0Ed47c04;
        MobBankFeeReceiver = 0x38797A5E4Bf8e6E630B1Ce04349603152D285082;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountETHMobBank = amountETH.mul(MobBankFee).div(totalETHFee);

        (bool tmpSuccess,) = payable(marketingFeeReceiver).call{value: amountETHMarketing}("");
        (tmpSuccess,) = payable(MobBankFeeReceiver).call{value: amountETHMobBank}("");
    ...
    function setFees(uint256 _liquidityFee, uint256 _teamFee, uint256 _marketingFee, uint256 _MobBankFee, uint256 _burnFee, uint256 _feeDenominator) external authorized {
        ...
        MobBankFee = _MobBankFee;
        burnFee = _burnFee;
        totalFee = _liquidityFee.add(_teamFee).add(_marketingFee).add(_MobBankFee).add(_burnFee);
    ...
    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _MobBankFeeReceiver, address _burnFeeReceiver, address _teamFeeReceiver) external authorized {
        ...
        MobBankFeeReceiver = _MobBankFeeReceiver;
