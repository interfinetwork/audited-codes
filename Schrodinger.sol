...
contract Schrodinger is Context, IERC20, Ownable {
    ...
    string private  _symbol             = "$ElonsCat";
    ...
    address payable public _wallet_marketing = payable(0x76D4296aCDB4fE17cFcEe0741f54AC6B74A26532);

    // for burn
    uint256 public _fee_burn = 0;
    uint256 private _fee_burn_old = _fee_burn;
    address payable public _wallet_burn = payable(0x76D4296aCDB4fE17cFcEe0741f54AC6B74A26532);

    // for buyback
    uint256 public _fee_buyback = 0;
    uint256 private _fee_buyback_old = _fee_buyback;
    address payable public _wallet_buyback = payable(0x76D4296aCDB4fE17cFcEe0741f54AC6B74A26532);

    // Auto LP
    uint256 public _fee_liquidity = 300;
