...
//Son Of Saitama Contract /////////////

contract SonOfSaitama is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'SonOfSaitama';
    string private constant _symbol = 'SOS';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 1000000000 * 10**_decimals;//equals 1 Billion tokens

    //Divider for the MaxBalance based on circulating Supply (1.5%)
    uint8 public constant BalanceLimitDivider=66;
    //Divider for sellLimit based on circulating Supply (.9%))
    uint16 public constant SellLimitDivider=110;
    ...
    //DevWallets
    address public TeamWallet=payable(0x6407597ee4761Bc241253BA3D51B9f6B564B935C);
    address public walletTwo=payable(0x05667c15E022445Dba06ce4E30A5539f54bdE11b);
    //TestNet
	...
	uint256 private antiWhale = 11000000 * 10**_decimals;
