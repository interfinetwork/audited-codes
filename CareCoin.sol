...
/*
_______  ________  ________  _______           ________  ________  ___  ________      
|\   ____\|\   __  \|\   __  \|\  ___ \         |\   ____\|\   __  \|\  \|\   ___  \    
\ \  \___|\ \  \|\  \ \  \|\  \ \   __/|        \ \  \___|\ \  \|\  \ \  \ \  \\ \  \   
 \ \  \    \ \   __  \ \   _  _\ \  \_|/__       \ \  \    \ \  \\\  \ \  \ \  \\ \  \  
  \ \  \____\ \  \ \  \ \  \\  \\ \  \_|\ \       \ \  \____\ \  \\\  \ \  \ \  \\ \  \ 
   \ \_______\ \__\ \__\ \__\\ _\\ \_______\       \ \_______\ \_______\ \__\ \__\\ \__\
    \|_______|\|__|\|__|\|__|\|__|\|_______|        \|_______|\|_______|\|__|\|__| \|__|
*/
/*
All Social: @carecoinfamily
*/
...
// File: contracts/CARECOIN.sol

pragma solidity ^0.8.10;

contract CareCoin is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 60 * 10**15 * 10**9;
    ...
    address public _marketingWallet =
        payable(address(0x325c66732eaf5047b2DBBD8EC8e62B902FF8af8f));
    
    address public _donationWallet = payable(address(0x00C3bDb889bA5fdb80b147e7a09483fa27f1933a));
    ...
    uint8 public constant BLOCKCOUNT = 25;
    ...
    uint256 private numTokensSellToAddToLiquidity = 60 * 10**11 * 10**9;
   ...
   function setDonationWallet(address payable wallet) external onlyOwner {
        require(wallet != address(0), "donationWallet address can not be zero!");
    ...
    function _takeLiquidityAndDonation(uint256 tLiquidity, uint256 tDonation)
        private
    {
        uint256 currentRate = _getRate();
        uint256 rLiquidity = tLiquidity.mul(currentRate);
        ...
        _rOwned[_donationWallet] = _rOwned[_donationWallet].add(rDonation);

       if (_isExcluded[address(this)])
            _tOwned[address(this)] = _tOwned[address(this)]
                .add(tLiquidity);
     
      if (_isExcluded[_donationWallet])
            _tOwned[_donationWallet] = _tOwned[_donationWallet]
                .add(tDonation);
       
    }

    function _takeMarketingAndBurn(
       ...
       if (_isExcluded[_marketingWallet])
            _tOwned[_marketingWallet] = _tOwned[_marketingWallet]
                .add(tMarketing);
     _rOwned[_burnWallet] = _rOwned[_burnWallet].add(rBurn);
       if (_isExcluded[_burnWallet])
            _tOwned[_burnWallet] = _tOwned[_burnWallet]
                .add(tBurn);
    ...
    function calculateDonationFee(uint256 _amount)
        ...
        returns (uint256)
    {
        return _amount.mul(_donationFee).div(10**3);
    }
    ...
    function setBuy() private {
        ...
        _donationFee = buyFee.donationFee;
    }
    ...
    function setSell() private {
        ...
        _donationFee = sellFee.donationFee;
    }
    ...
    function _transferStandard(
        ...
        _takeLiquidityAndDonation(tLiquidity, calculateDonationFee(tAmount));
