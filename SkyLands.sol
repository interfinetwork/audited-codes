...
// File: contracts/SkyLands.sol


pragma solidity ^0.8.6;


contract SkyLandsToken is IERC20, Ownable {
    ...
    string private _name = "SkyLands Token";
    string private _symbol = "SKYLANDS";
    ...
    uint256 public _taxFee = 200; // 2% for reflection
    uint256 private _previousTaxFee = _taxFee;

    uint256 public _liquidityFee = 200; // 2% for liquidity
    uint256 private _previousLiquidityFee = _liquidityFee;

    uint256 public _marketingFee = 700; // 7% for marketing
    uint256 private _previousMarketingFee = _marketingFee;
    address public _marketingAddress = 0x23b0DA3AFB264ba14677b41a50E41EF7788c1463;
    ...
    function _transfer(
        ...
        if (
            balanceOf(_marketingAddress) >= numTokensSellToAddToLiquidity &&
            !inSwapAndLiquify &&
            from != uniswapV2Pair &&
            swapAndLiquifyEnabled
        ) {
            // swap marketing
            swapMarketingTokensForEth(numTokensSellToAddToLiquidity);
        }
    ...
    function swapMarketingTokensForEth(uint marketingTokenBalance) private lockTheSwap {
        _tokenTransfer(_marketingAddress, address(this), marketingTokenBalance, false);
        ...
        _approve(address(this), address(uniswapV2Router), marketingTokenBalance);
