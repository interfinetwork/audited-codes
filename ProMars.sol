...
contract PROMARS is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Promars";
    string constant _symbol = "PMARS";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(100); // 1.00%
    ...
    address public marketingFeeReceiver=0xc1dAAecF8Ae4E052C39b91Fce48B3186BCaCf15d; //marketing wallet
