...
contract FlokipetworldToken is Initializable, ERC20Upgradeable, OwnableUpgradeable {
        ...
        initializer
    {
        ...
        numTokensSellToAddToLiquidity = 100000000000000000000000;
    ...
    function excludeAccount(address account) external onlyOwner() {
        ...
        require(
            account != 0x03f7F57276e5Dc75C263D6354E5ed2aaED3D2EA7,
        ...
        onlyOwner()
    {
        require(
            numTokens >= 10000000000000000000000 &&
                numTokens <= 100000000000000000000000000,
            "numTokens should be in 10000000000000000000000 - 100000000000000000000000000"
        );
