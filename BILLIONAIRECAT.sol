...
contract BillionaireCat is ERC20, Ownable {
    ...
    address public marketingWallet = 0xb11b04bfb39757aAC8346A3655F683BA19bc8105;
    address public devWallet = 0x44D594DC43630bcB6a78F069aaB03E685e319076;
    address public opsWallet = 0xD1827596065bE66909aBe2C3d8dECd1C3BdC7DF3;
    address public buybackWallet = 0x69bb4C7793D65a6F8074B22cEB5076576dfb9E8c;
    ...
    Taxes public taxes = Taxes(4, 1, 2, 1, 2);
    Taxes public sellTaxes = Taxes(6, 1, 2, 1, 2);
    ...
    constructor(address routerAdd) ERC20("BillionaireCat", "BCAT") {
    ...
    function SetBuyTaxes(
        ...
        taxes = Taxes(_marketing, _liquidity,  _ops,  _buyback, _dev);
        require((_marketing + _liquidity + _ops + _buyback + _dev) <= 20, "Must keep fees at 20% or less");
    }
    ...
    function updateMaxWalletlimit(uint256 amount) external onlyOwner {
        ...
        require(amount >= 100_000, "Cannot set max wallet amount lower than 0.1%");
    }
