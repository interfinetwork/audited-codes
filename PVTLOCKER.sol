...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    contract PVTL is ERC20, Ownable {
        using SafeMath for uint256;
        using Address for address;

        string private    _name = "PVTLocker";
        string private  _symbol = "PVTL";
    ...
    uint256 public _maintenanceFee = 9; //3% product development + 3% marketing +3% team
   ...
   address payable maintenanceWallet = payable(0xF7234F7AbDEf394F57B8bcdB5E8C88674Ba16CD2);
    ...
    function _transfer(
        ...
        require(_isBot[from] == false && _isBot[to] == false, "Bots are frobidden");
    ...
    function swapBack(uint256 tokensToLiquify) internal lockTheSwap {
        ...
        uint256 bnbForMaintenance = bnbBalance.mul(_maintenanceFee).div(bnbFeeFactor);
      
      

        addLiquidity(tokensToLP, bnbForLiquidity);

        payable(maintenanceWallet).transfer(bnbForMaintenance);
    }
