...
/**
 *Submitted for verification at Etherscan.io & Contract Audit on 2022-02-13
 */
...
contract BV is ERC20("BV", "BV"), Ownable {
    ...
    uint256 public maxTransferAmountRate = 200;
    ...
    address public marketingWallet = 0xd06e56C33BbE084065264bFf0810f7392F9C230C;
    address public devWallet = 0xd06e56C33BbE084065264bFf0810f7392F9C230C;
    address public extraLottoWallet = 0xd06e56C33BbE084065264bFf0810f7392F9C230C;
    ...
    function manualWithdraw() external onlyOperator {
        ...
        payable(marketingWallet).transfer(balForMarketing);
        payable(devWallet).transfer(balFordev);
        payable(extraLottoWallet).transfer(balForExtraLotto);
    }
