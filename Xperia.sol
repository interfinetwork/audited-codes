...
contract XPERIAXPR is IBEP20, Auth {
    ...
    function setMultipliers(uint256 _buy, uint256 _sell, uint256 _trans) external authorized {
        ...
        require(totalFee.mul(buyMultiplier).div(100) < (feeDenominator/3), "Tax cannot be more than 32%");
        require(totalFee.mul(sellMultiplier).div(100) < (feeDenominator/3), "Tax cannot be more than 32%");
    }
    ...
    function swapBack() internal swapping {
        ...
        utilityFeeReceiver.transfer(amountBNButility);
    ...
    function setFees(uint256 _liquidityFee, uint256 _rewardFee, uint256 _marketingFee, uint256 _utilityFee, uint256 _stakingFee, uint256 _devFee, uint256 _feeDenominator) external onlyOwner {
