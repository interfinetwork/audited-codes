...
/*
Welcome to OrbitInu
Our multi chain dex will launch and tokenomics carefully engineered to benefit holders, and features NFT, Marketplace, Staking & P2E!
...
Telegram: https://t.me/orbitinu
Website: https://orbitinu.space
*/
...
contract OrbitInu is Context, IBEP20, Ownable {
    ...
    address payable public _externalAddress  = payable(0x694e6828a3fbD51ea5c154689e73585b567591D1);
    address payable public _burnAddress      = payable(0x000000000000000000000000000000000000dEaD);
    address payable public autoLiquidityReceiver = payable(0xAe7A84CE15FDCCF84eb936f7d8dE9Cf5Bc0B1e81); 

    string private _name    = "OrbitInu";
    string private _symbol  = "OIM81";
    ...
    uint256 public _externalFee             = 40;
