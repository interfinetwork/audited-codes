...
contract MIMI is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 5_000_000_000 * 10**18; // 5 Billion
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    address public deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x7D13c723284583577b5a9939E8a1758c300F621f; // marketing fee address
    string private _name = "MIMI";
    string private _symbol = "MIMI";
    uint8 private _decimals = 18;
    
    // Transfer taxes 0% at launch
    ...
    // Total tax on buying 0% at launch
    uint256 public buyTaxFee = 0;
    uint256 public buyLiquidityFee = 0;
    uint256 public buyMarketingFee = 0;
    uint256 public buyburnFee = 0;
    
    // Total tax on selling 15% at launch
    uint256 public SellTaxFee = 3; // reward fee
    ...
    uint256 public numTokensSellToAddToLiquidity = 5_000_000_000 * 10**18;
    uint256 public _maxTxAmount = 250_000_000 * 10**18; // 5%
    ...
    function setTaxFeePercent(uint256 taxFee,uint256 liquidityFee,uint256 burnFee,uint256 marketFee) external onlyOwner() {
        _taxFee = taxFee;
        _liquidityFee = liquidityFee;
        _burnFee = burnFee;
        _marketingFee = marketFee;
    }    
    function setSellTaxFee(uint256 taxFee,uint256 liquidityFee,uint256 burnFee,uint256 marketFee) external onlyOwner() {
        buyTaxFee = taxFee;
        buyLiquidityFee = liquidityFee;
        buyMarketingFee = marketFee;
        buyburnFee = burnFee;
    }
     function setBuyTaxFee(uint256 taxFee,uint256 liquidityFee,uint256 burnFee,uint256 marketFee) external onlyOwner() {
        SellTaxFee = taxFee;
        SellLiquidityFee = liquidityFee;
        SellMarketingFee = marketFee;
        SellburnFee = burnFee;
    }
