...
contract EFT is ERC20, Ownable {
  ...
  //  uint256 public extraFeeOnSell = 4;
    ...
    uint256 public maxWallet = 10000000000000 * (10**18); //1%
    ...
    function setMaxWallet(uint256 _maxToken) external onlyOwner {
        require(_maxToken >= totalSupply().div(100), "Maximum wallet amount should be more than 1% of total supply");
  	    maxWallet = _maxToken;
  	}
  	
  	function setMaxtx(uint256 _maxTxAmount) public onlyOwner {
          require(_maxTxAmount >= totalSupply().div(100), "Maximum tx amount should be more than 1% of total supply");
