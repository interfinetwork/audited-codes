...
contract LiberoTitano is ERC20Detailed, Ownable {
    ...
    address public liquidityReceiver = 0x7EddA35b8A5f08a6927A8EAc21cA4636cf2c5758;
    address public treasuryReceiver = 0x7EddA35b8A5f08a6927A8EAc21cA4636cf2c5758;
    address public riskFreeValueReceiver = 0x7EddA35b8A5f08a6927A8EAc21cA4636cf2c5758;
    ...
    constructor() ERC20Detailed("LiberoTitano", "LIBT", uint8(DECIMALS)) {
    ...
    function setMaxSellTransaction(uint256 _maxTxn) external onlyOwner {
        require(_maxTxn >= ((_totalSupply / 100)), "Max Sell transaction must be more then 1% of the supply");
