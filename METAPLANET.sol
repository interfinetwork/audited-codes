...
/**
    ...
    Telegram: t.me/MetaPlanetOfficial
    Website:  metaplanet.finance
...
contract MetaPlanet is Context, IERC20, Ownable {
    ...
    uint256 public maxSellLimit = 50_000_000 * 10**9;
    uint256 public maxWalletLimit = 200_000_000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x16eD2a6D77ec2bB27BCd1E3ABCB57bBdA888Acc5;
    address public devWallet = 0x317F2C530a4d4f58545b8934744C62eD54C818Cb;
    address public gamedevWallet = 0xF69C698883Ba6A89B7ed642916dd6798E00e19f7;

    string private constant _name = "MetaPlanet";
    string private constant _symbol = "MPL";
    ...
    Taxes public taxes = Taxes(1, 6, 2, 1, 2);
    Taxes public sellTaxes = Taxes(1, 6, 2, 1, 2);
