...
/**
    ...
    Telegram: https://t.me/sonofsantatokenbsc
...
contract SONOFSANTA is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x4a70D26cEa2ab7faac57F15B6D46b460f282A7ca;
    address public devWallet = 0x893e88da67387636D4054DFaf94151ac5872e5Cf;
    address public operationWallet = 0x3eC399ae4B3621D6c5564800Aed255457BBd2707;
    address public charityWallet = 0xc0e93C8022e90c36F3ecd29A69E18DdbaD3f69e4;

    string private constant _name = "Son Of Santa";
    ...
    Taxes public taxes = Taxes(2, 5, 2, 1, 1, 1);
    Taxes public sellTaxes = Taxes(2, 5, 2, 1, 1, 2);
