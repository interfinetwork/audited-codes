...
contract AscentPad is Context, IERC20, Ownable {
    ...
    string private _name = "AscentPad";
    string private _symbol = "ASP";
    ...
    address public marketingWallet = 0x7b398f8Fe08F31267Cd8b30A74B71CbD6c8FC492;
    address public deadAddress = 0x000000000000000000000000000000000000dEaD;
    
    uint256 public totalFeesTax= _taxFee.add(_marketingFee);
    ...
    uint256 public numTokensSell = 50000 * 10**18;
    ...
    constructor() {
        ...
        excludedFromAntiWhale[deadAddress] = true;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private 
    {
        ...
        if (maxTransferAmount() > 0 && (sender == address(uniswapV2Pair) || recipient == address(uniswapV2Pair))) {
            if (
    ...
    function setTaxFeePercent(uint256 taxFee) external onlyOwner() {
        _taxFee = taxFee;
        totalFeesTax = _taxFee.add(_marketingFee);
    ...
    // should call without decimals in parameter
    function setNumTokensSellToAddToLiquidity(uint256 newAmt) external onlyOwner() {
        require(newAmt <= 200000,"max 200 000 tokens");
        numTokensSell = newAmt*10**18;
    }
