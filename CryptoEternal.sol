...
contract CryptoEternal is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("CryptoEternal", "CRETEL") {

        address newOwner = address(0x92F2199E29Ebe269C72bf54Fce543A3fEA028Ce6);
    	...
    	marketingWallet = address(0xd86fCCe80e613DBA6D9d7F388Ef5F76212B345B2);
    	buyBackWallet = address(0x779dAf04cBB1e2985E997011abD214c28df34778);
