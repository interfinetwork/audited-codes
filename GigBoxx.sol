...
contract GigBoxx is IBEP20, GigsAuth {
    using SafeMath for uint256;
    ...
    string constant _name = "GigBoxx";
    string constant _symbol = "Gigs";
    uint8 constant _decimals = 18;

    uint256 _totalSupply =1000000000000000000000000000; // 1 billionn
    ...
    constructor () GigsAuth(msg.sender) {
