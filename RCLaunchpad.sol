...
contract RCLaunchPadDeployer is Ownable, constructorLibrary{
    ...
    constructor (address payable _fundsWallet, address payable _lpWallet, address tokenForDiscount )  {
    ...
    function changeLPWallet(address payable newWallet) public onlyOwner {
    ...
    function changeDiscountTokenAddress(address newAddress) public onlyOwner {
        //Only use 18 decimal tokens
        discountToken = IERC20(newAddress);
    }
