...
contract BM is Context, IERC20, IERC20Metadata, Ownable {
    ...
    string private _name = "BtMiracles";
...
contract BMTokenGuard is Ownable {
    ...
    function addBlackList(address _blackAddress) public onlyOwner{
        blackList[_blackAddress] = true;
    }
    
    function removeBlackList(address _blackAddress) public onlyOwner{
        blackList[_blackAddress] = false;
    }
    ...
    function protect( address sender, address receiver, uint256 amount ) view public{
