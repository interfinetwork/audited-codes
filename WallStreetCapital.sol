...
contract WALLSTREETCAPITAL is IBEP20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x03d2c89888AA5c2162Afc9DA9113501a818A9996;
        treasuryFeeReceiver = 0x70FdBd6AC57b57E3c29fEC2C67BE0515ce634806;
    ...
    function setFees(uint256 _liquidityFee, uint256 _devFee, uint256 _marketingFee, uint256 _treasuryFee, uint256 _burnFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        devFee = _devFee;
        marketingFee = _marketingFee;
        treasuryFee = _treasuryFee;
        burnFee = _burnFee;
        totalFee = _liquidityFee.add(_devFee).add(_marketingFee).add(_treasuryFee).add(_burnFee);
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator/2, "Fees cannot be more than 50%");
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _treasuryFeeReceiver, address _burnFeeReceiver, address _devFeeReceiver) external authorized {
