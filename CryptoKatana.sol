...
// cryptokatana.io  made with ♥
contract CryptoKatanaNFT is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function mint(address _to, uint256 _mintAmount) public payable {
    ...
    require(walletOfOwner(msg.sender).length < maxMintPerWallet , "max NFT per address exceeded" );
    ...
    if (msg.sender != owner()) {
        ...
        {
        require(msg.value >= (cost * _mintAmount * 80) / 100 );
        }
