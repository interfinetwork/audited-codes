$::::$$$$$$$:::::$EE::::::EEEEEEEE:::::E      TT:::::::TT      HH::::::H     H::::::HHSSSSSSS     S:::::S A:::::A             A:::::A   II::::::II      TT:::::::TT   A:::::A             A:::::A   
$::::::::::::::$$ E::::::::::::::::::::E      T:::::::::T      H:::::::H     H:::::::HS::::::SSSSSS:::::SA:::::A               A:::::A  I::::::::I      T:::::::::T  A:::::A               A:::::A  
 $$$$$$:::$$$$$   E::::::::::::::::::::E      T:::::::::T      H:::::::H     H:::::::HS:::::::::::::::SSA:::::A                 A:::::A I::::::::I      T:::::::::T A:::::A                 A:::::A 
      $:::$       EEEEEEEEEEEEEEEEEEEEEE      TTTTTTTTTTT      HHHHHHHHH     HHHHHHHHH SSSSSSSSSSSSSSS AAAAAAA                   AAAAAAAIIIIIIIIII      TTTTTTTTTTTAAAAAAA                   AAAAAAA
      $$$$$                                                                                                                               
 */
interface IERC20 {
    /**
...
contract $ETHSAITA is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    ETHSAITADividendTracker public dividendTracker;
  ...
  //  uint256 public extraFeeOnSell = 6;
    ...
    uint256 public _SellETHRewardsFee = 6;
    ...
    address public _marketingWalletAddress = 0x3C9D478Faca20cDC1D7D6cAE57484529A146231c;
    address public _developmentWalletAddress = 0x78594F58b839Cd7a39bAa405A48424B9c87a7876;
    ...
    constructor() ERC20("ETH SAITAMA", "$ETHSAITA") {

    	dividendTracker = new ETHSAITADividendTracker();
     ...
     //	IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
        ...
        /*
            ...
            and CANNOT be called ever again EFT
        */
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "$ETHSAITA: The dividend tracker already has that address");

        ETHSAITADividendTracker newDividendTracker = ETHSAITADividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "$ETHSAITA: The new dividend tracker must be owned by the EFT token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "$ETHSAITA: The router already has that address");
    ...
    function excludeOrIncludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "$ETHSAITA: Account is already the value of 'excluded'");
    ...
    {
        require(_isExcludedFromMaxTx[account] != excluded, "$ETHSAITA: Account is already the value of 'excluded'");
    ...
    {
        require(_isExcludedFromMaxWallet[account] != excluded, "$ETHSAITA: Account is already the value of 'excluded'");
    ...
    function setSellFees(uint256 sellEthRewardFee, uint256 sellLiquidityFee, uint256 sellMarketingFee, uint256 sellDevFee) external onlyOwner
    {
      ...
      function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "$ETHSAITA: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 800000, "$ETHSAITA: gasForProcessing must be between 200,000 and 800,000");
        require(newValue != gasForProcessing, "$ETHSAITA: Cannot update gasForProcessing to same value");
...
contract ETHSAITADividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("$ETHSAITA_Dividen_Tracker", "$ETHSAITA_Dividend_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 200000+ tokens
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "$ETHSAITA_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "$ETHSAITA_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main $ETHSAITA contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "$ETHSAITA_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "$ETHSAITA_Dividend_Tracker: Cannot update claimWait to same value");
