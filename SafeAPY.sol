...
/*
SafeAPY
Website: https://safeapy.finance/
Twitter: https://twitter.com/SafeAPY
Telegram: https://t.me/SafeAPY
...
contract SafeAPY is ERC20Detailed, Ownable {
    ...
    string public _name = "SafeAPY";
    string public _symbol = "APY";
    ...
    uint256 public safeInsuranceFundFee = 50;
    uint256 public sellFee = 20;
    uint256 public supplyControlFee = 25;
    uint256 public totalFee =
        liquidityFee.add(treasuryFee).add(safeInsuranceFundFee).add(
            supplyControlFee
        );
    ...
    address public safeInsuranceFund;
    ...
    constructor() ERC20Detailed("SafeAPY", "APY", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityFund = 0x36ea5535e4d8a870e9c8526d1DE3EC196e4380e4;
        treasuryFund = 0xF7Bdc7666eA80f843973d856df081A70551A643b;
        safeInsuranceFund = 0x0e48cAe51e82271059d00cB416881ec9878eE9C3;
        supplyControl = 0x6670701B569d276bacDEA3369EE5B4DCdd914E7f;
    ...
    function takeFee(
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.div(feeDenominator).mul(_treasuryFee.add(safeInsuranceFundFee))
        );
    ...
    function swapBack() internal swapping {
        ...
        (bool success, ) = payable(treasuryFund).call{
            value: amountETHToTreasuryAndSIF.mul(treasuryFee).div(
                treasuryFee.add(safeInsuranceFundFee)
            ),
            gas: 30000
        }("");
        (success, ) = payable(safeInsuranceFund).call{
            value: amountETHToTreasuryAndSIF.mul(safeInsuranceFundFee).div(
                treasuryFee.add(safeInsuranceFundFee)
            ),
            gas: 30000
        }("");
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no SafeAPY token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
