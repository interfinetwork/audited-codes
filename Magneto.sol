...
contract MagnetoToken is ERC20Detailed, Ownable {
    ...
    address public liquidityReceiver = msg.sender; //Emitting wallet
    address public treasuryReceiver = msg.sender; 
    address public riskFreeValueReceiver = msg.sender; 
    ...
    constructor() ERC20Detailed("Magneto", "MGO", uint8(DECIMALS)) {
