...
Telegram: https://t.me/iPayToken
Website: https://www.ipaytoken.com/
*/
...
contract iPay is Context, IBEP20, Ownable {
    ...
    address payable public _externalAddress  = payable(0x74f7f02eE768Ea46094bb931a3E56ea478f52560);
    address payable public _burnAddress      = payable(0x000000000000000000000000000000000000dEaD);

    string private _name    = "iPay";
    string private _symbol  = "iPay";
    ...
    uint256 private _externalFeeBuy             = 100;
    uint256 private _previousExternalFeeBuy    = _externalFeeBuy;
    
    uint256 private _liquidityFeeBuy            = 0;
    ...
    uint256 private _externalFeeSell             = 100;
    uint256 private _previousExternalFeeSell    = _externalFeeSell;
    
    uint256 private _liquidityFeeSell            = 0;
    ...
    uint256 public _maxTxAmountSell                 = 1000000000 * 10**_decimals;
    uint256 public _numTokensSellToAndTransfer      = 150000 * 10**_decimals;
    uint256 public _maxTokensPerAddress             = 1000000000 * 10**_decimals;
