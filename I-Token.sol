...
contract iTOKEN is Context, IERC20, Ownable {
    ...
    address payable public liquidityAddress =
        payable(0x722e3802607b8287D99Bf32e17B7c7f5f38557D8); // Liquidity Address
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 3 / 10000; // 0.3% max txn
        minimumTokensBeforeSwap = _tTotal * 5 / 10000; // 0.05%
        maxWallet = _tTotal * 0.3 / 100; // 0.3%
        ...
        liquidityAddress = payable(address(0x722e3802607b8287D99Bf32e17B7c7f5f38557D8)); // update to a liquidity wallet if you don't want to burn LP tokens generated by the contract.
