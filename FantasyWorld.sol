...
contract FantasyWorldGold is Context, IERC20, Ownable {
    ...
    uint256 private previousMarketingBuyFee;
 
    uint256 public marketingSellFee;
    uint256 private previousMarketingSellFee;
    ...
    constructor() {
        ...
        _liquidityFee = buybackFee + marketingSellFee;
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        transferToAddressETH(
            marketingAddress,
            transferredBalance.div(_liquidityFee).mul(marketingBuyFee)
        );
    }
    ...
    function setBuybackFee(uint256 _buybackFee) external onlyOwner {
        ...
        _liquidityFee = buybackFee.add(marketingSellFee);
    }
    ...
    function setMarketingBuyFee(uint256 _marketingBuyFee) external onlyOwner {
        marketingBuyFee = _marketingBuyFee;
    }
 
    function setMarketingSellFee(uint256 _marketingSellFee) external onlyOwner {
        marketingBuyFee = _marketingSellFee;
        _liquidityFee = buybackFee.add(_marketingSellFee);
    }
