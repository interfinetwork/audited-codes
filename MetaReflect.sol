...
contract MetaReflect is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MetaReflect";
    string constant _symbol = "MRF";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 100*10**13 * (10 ** _decimals);
    ...
    function MetaBurn(uint256 amount) external authorized {
  ...
  function startTrading() external authorized {
    ...
    /* Airdrop */
    function MetaRain(address from, address[] calldata addresses, uint256[] calldata tokens) external onlyOwner {
