...
contract RUNNER is Context, IBEP20, Ownable {
    ...
    string private _name     = "Front-Runners";
    string private _symbol   = "FRUNNER";
    uint8 private  _decimals = 18;
    
    uint256 private _taxFee; 
    uint256 public _liquidityFee = 5; 
    uint256 public _percentageOfLiquidityForMarketing = 20; 
    uint256 public maxWalletToken = 1000000 * (10**18);

    
    uint256 public  _maxTxAmount     = 500000 * 10**18;
    uint256 private _minTokenBalance = 500000 * 10**18;
    ...
    function setmaxTxnamount(uint256 maxtxnamount) external onlyOwner{
