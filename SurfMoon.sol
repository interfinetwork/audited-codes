...
contract SurfMoon is ERC20, Ownable {
    ...
    address public _marketingWallet = 0x97c52bF89fc71C9727fc88BFCea6f42CC7Bc0e1D;

    bool public restrictWhales = false;

    uint256 public maxTxAmount = 1000000000 * (10**9);
    uint256 public walletMax = 1000000000 * (10**9);
    ...
    function prepareForLaunch() external onlyOwner {
        ...
        maxTxAmount = 800000000 * (10**9);
        walletMax = 100000000 * (10**9);
    }
