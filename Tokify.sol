...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 dividendToken = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
    ...
    constructor (address _router, address _rewardsPoolAddress) {
...
interface IRewardsPool {
    function transferToDistributor(address distributorAddress, uint256 amount) external;
...
contract RewardsPool is IRewardsPool {
    ...
    function transferToDistributor(address distributor, uint256 amount) external override onlyToken {
...
contract TokifyRisingFloor is IBEP20, Auth {
    ...
    constructor (
        ...
        dividendDistributor = new DividendDistributor(_dexRouter, rewardsPoolAddress);
...
//        emit Transfer(sender, recipient, amount);
    ...
    function payoutFractionOfRewardsPool(uint256 numerator, uint256 denominator) external authorized {
        ...
        rewardsPool.transferToDistributor(dividendDistributorAddress, toDistribute);
    }
    ...
    /// @dev get amount of BNB stored in the asset pool (this contract)
    function getDistributorPoolBalance() public view returns (uint256) {
        address dividendTokenAddress = dividendDistributor.viewDividendTokenAddress();
        IBEP20 dividendToken = IBEP20(dividendTokenAddress);
        dividendToken.balanceOf(dividendDistributorAddress);
        return dividendToken.balanceOf(dividendDistributorAddress);
    }
