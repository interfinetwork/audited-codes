...
contract RC2 is ERC20, Ownable {
    ...
    address public marketingWallet = 0xAc3DC42d57de3D868E7080d112E2c85E2B901D1a;
    address public devWallet = 0xD4d508BbedCA2E4EC05284D44947E203B9b2EcFC;
    ...
    IERC20 public RC1 = IERC20(0x229a54Fb9De889C271380452C0483ce89b8C1e0D);
...
contract RC1DividendTracker is DividendPayingToken {
    ...
    constructor() DividendPayingToken("RC2_RC1_Dividend_Tracker", "RC2_RC1_Dividend_Tracker", 0x229a54Fb9De889C271380452C0483ce89b8C1e0D) {
    	claimWait = 3600;
...
contract BUSDDividendTracker is DividendPayingToken {
    ...
    constructor() DividendPayingToken("RC2_BUSD_Dividend_Tracker", "RC2_BUSD_Dividend_Tracker", 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56) {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 2000000 * (10**18); //must hold 2000000+ tokens
    }
