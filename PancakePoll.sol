 ...
 * Hold PancakePoll $PPOLL and get rewarded.
 * 
...
contract PancakePoll is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    PPOLLDividendTracker public dividendTracker;
    ...
    constructor() ERC20("PancakePoll", "PPOLL", 9) {

        dividendTracker = new PPOLLDividendTracker();
		
		liquidityWallet = 0xBb84aBFdd2d4d3fec5D0fd48fA752DBd307eF3d7;
        operationsWallet = 0x01abf38e346781216C06df8402D0aD1A8B0E6aAD;
        buyBackWallet = 0x1606Ca70575Fe8f137c6698C3772B51E0bb5F474;
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        PPOLLDividendTracker newDividendTracker = PPOLLDividendTracker(payable(newAddress));
...
contract PPOLLDividendTracker is DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("PPOLL_Dividend_Tracker", "PPOLL_Dividend_Tracker", 9) {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 10 * 10 ** 6 * (10**9); //must hold 10,000,000+ tokens to get divs
    }

    function _transfer(address, address, uint256) pure internal override {
        require(false, "PPOLL_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() pure public override {
        require(false, "PPOLL_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main PancakePoll contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "PPOLL_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "PPOLL_Dividend_Tracker: Cannot update claimWait to same value");
