...
// File: contracts/token/ERC20/AurousArgentum.sol
...
/**
 * @title AurousArgentum
 * @dev Implementation of the AurousArgentum
 */
contract AurousArgentum is ERC20Decimals, ERC20Capped, ERC20Mintable, ERC20Burnable, Ownable, ServicePayer {
    constructor(
        string memory name_,
        ...
        ERC20Capped(cap_)
        ServicePayer(feeReceiver_, "AurousArgentum")
    {
