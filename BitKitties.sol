...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 rewardsToken = IBEP20(0xBc7b86fce7B248c5f4DFefa2faBd3B30b4d3D16C);
   // address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    constructor (address _router) {
        router = _router != address(0)
            ...
            : IDEXRouter(0x482eC5Bac2e048014187D245b2C8aaa49A6284a8);
        _token = msg.sender;
    }
...
contract BitKitties is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    uint256 public _sellWait = 900; //test

    address[] public _privatesaleWallets =  [
        0xa9147DcDce9dA13Ea4aC3a3c20fd187c724e460c,
        0xECA6Cfa82188034E1812A97fD2d8384424Ee579D,
        0x5451998B2eaF9c7Bb3F36aBd6DE657100aECd38B
    ];
    ...
    address constant private _routerAddress = 0x482eC5Bac2e048014187D245b2C8aaa49A6284a8;
    ...
    constructor () Auth(msg.sender) {
        ...
        router = IDEXRouter(0x482eC5Bac2e048014187D245b2C8aaa49A6284a8);
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        if(sniperProtection) {
          ...
          if(isSniper(sender) && sender != pair) {
            revert('Sniper rejected.');
          }
          // check if this is the liquidity adding tx to startup.
          if(hasLiquidityBeenAdded == false) {
