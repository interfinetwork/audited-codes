...
abstract contract BEP20Mintable is BEP20 {
     ...
     */
    function mintingFinished() public view virtual returns (bool) {
     ...
     */
    function mint(address account, uint256 amount) public virtual canMint {
 ...
 */
contract PowerfulBEP20 is BEP20Capped, BEP20Mintable, BEP20Burnable, BEP20Operable, TokenRecover, Roles, ServicePayer {
    constructor(
        string memory name_,
    ...
    ) payable BEP20(name_, symbol_) BEP20Capped(cap_) ServicePayer(feeReceiver_, "PowerfulBEP20") {
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(AccessControl, BEP20Operable)
        returns (bool)
    {
     ...
     * @dev Function to mint tokens.
     *
     * NOTE: restricting access to addresses with MINTER role. See {BEP20Mintable-mint}.
     *
     * @param account The address that will receive the minted tokens
     * @param amount The amount of tokens to mint
     */
    function _mint(address account, uint256 amount) internal override(BEP20, BEP20Capped) onlyMinter {
        super._mint(account, amount);
    }
