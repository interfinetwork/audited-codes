...
15% Buy/Sell Taxes in Total 

Maximum Buy/Sell Taxes Capped at 30%
...
contract SNOKI is Context, IERC20, Ownable {
    ...
    string private _name = "SNOKI";
    string private _symbol = "SNOKI";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 1 * 10**9 * 10**_decimals;
    
    address payable public marketingAddress = payable(0xe2Da8Ac8975A93C5a9A4F351191Cdd3B39a9DE63);
    ...
    uint256 private constant _maxFees = 30;
