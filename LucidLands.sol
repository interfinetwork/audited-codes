...
abstract contract LLGBase is Context, IERC20Metadata, Ownable, ReentrancyGuard {
	...
	//Router address will be: 0x10ed43c718714eb63d5aa57b78b54704e256024e or for testnet: 0xD99D1c33F9fC3444f8101754aBC46c52416550D1
	//PinkAntiBot address will be: 0x8EFDb3b642eb2a20607ffe0A56CFefF6a95Df002 or for testnet: 0xbb06F5C7689eA93d9DeACCf4aF8546C4Fe0Bf1E5
	...
	function activate() public onlyOwner {
		...
		setTransactionLimit(600000 * 10**DECIMALS);
		activateBuying();
		onActivated();
	}
