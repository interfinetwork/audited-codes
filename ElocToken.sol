...
contract ELONSCURRENCY  is IBEP20, Auth {
    ...
    string constant _name = "Elon's Currency";
    string constant _symbol = "$ELOC";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x23aDE59671dA088DB97c64A32936f1D18324aedD;
        utilityFeeReceiver = 0x6AC486fC08FDD0a7306360D9B61634Aa16332520;
    ...
    function setFees(uint256 _liquidityFee, uint256 _devFee, uint256 _marketingFee, uint256 _utilityFee, uint256 _burnFee, uint256 _feeDenominator) external authorized {
    ...
    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _utilityFeeReceiver, address _burnFeeReceiver, address _devFeeReceiver) external authorized {
