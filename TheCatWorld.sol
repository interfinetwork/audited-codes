...
contract TheCatWorld is ERC20, Ownable {
    ...
    TheCatWorldDividendTracker public dividendTracker;

    address public constant deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x21a8c705bF1C6BF709352c03403b32A607E315FD;
    address public gamefeeWallet = 0xd2690e22eBAA01851a858ED9bebEdfC05b4ae8c7;
    address private devWallet = 0xc334Cf68A518571C610B87Fd698158A39Ac26321;
    ...
    Taxes public buyTaxes = Taxes(3, 5, 0, 2, 1);
    Taxes public sellTaxes = Taxes(3, 6, 0, 2, 1);
    ...
    constructor() ERC20("TheCatWorld", "CWORLD") {
        dividendTracker = new TheCatWorldDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        TheCatWorldDividendTracker newDividendTracker = TheCatWorldDividendTracker(
            payable(newAddress)
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "TheCatWorld: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
    ...
    function _setAutomatedMarketMakerPair(address newPair, bool value) private {
        require(
            ...
            "TheCatWorld: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[newPair] = value;
    ...
    function setGasForProcessing(uint256 newValue) external onlyOwner {
        require(
            ...
            "TheCatWorld: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "TheCatWorld: Cannot update gasForProcessing to same value"
        );
...
contract TheCatWorldDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("TheCatWorld_Dividen_Tracker", "TheCatWorld_Dividend_Tracker")
    {
        claimWait = 3600;
    ...
    function _transfer(
        ...
        require(false, "TheCatWorld_Dividend_Tracker: No transfers allowed");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "TheCatWorld_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "TheCatWorld_Dividend_Tracker: Cannot update claimWait to same value"
        );
