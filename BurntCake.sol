...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  address public constant token = address(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82); // CAKE
...
contract BurntCake is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Burnt Cake", "BCAKE") {
        
        address newOwner = address(0xb924C7826B104F756a1b61771B5EE27dC69C6E37);
        ...
        buyBackSellFee = 4;
        liquiditySellFee = 5;
        totalSellFees = rewardsSellFee + buyBackSellFee + liquiditySellFee;
        
        rewardsBuyFee = 10;
        buyBackBuyFee = 2;
        liquidityBuyFee = 3;
        totalBuyFees = rewardsBuyFee + buyBackBuyFee + liquidityBuyFee;
        
    	dividendTracker = new DividendTracker();
    	
    	buyBackWallet = address(0x6Eb98f17017efE0214197ef529c7655EbE453464); // set as buyBack wallet
    ...
    function updateBuyFees(uint256 _buyBackFee, uint256 _rewardsFee, uint256 _liquidityFee) external onlyOwner {
        buyBackBuyFee = _buyBackFee;
        rewardsBuyFee = _rewardsFee;
        liquidityBuyFee = _liquidityFee;
        totalBuyFees = buyBackBuyFee + rewardsBuyFee + liquidityBuyFee;
        require(totalBuyFees <= 20, "Must keep fees at 20% or less");
    }
    
    function updateSellFees(uint256 _buyBackFee, uint256 _rewardsFee, uint256 _liquidityFee) external onlyOwner {
        buyBackSellFee = _buyBackFee;
        rewardsSellFee = _rewardsFee;
        liquiditySellFee = _liquidityFee;
        totalSellFees = buyBackSellFee + rewardsSellFee + liquiditySellFee;
    ...
    function updateBuyBackWallet(address newBuyBackWallet) external onlyOwner {
        require(newBuyBackWallet != address(0), "cannot set to address 0");
    ...
    function swapBack() private {
        ...
        bool success;
        uint256 totalTokensToSwap = tokensForLiquidity + tokensForBuyBack + tokensForRewards;
        ...
        uint256 ethForLiquidity = ethBalance - ethForBuyBack - ethForRewards;
        ...
        // send remainder to buybackWallet
