...
contract GLT is Context, IERC20, Ownable {
    ...
    string constant private _name = "Green Light Token";
    string constant private _symbol = "GLT";
    ...
    address public _charityWalletAddress = 0xBeFcb4743F412267760D40319aEF8c44Af8BE70C;
    ...
    uint256 public _maxTxAmount = 2000000000000000 * 10**8;
    ...
    function _getRValues(uint256 tAmount, uint256 tFee, uint256 tBurn, uint256 tCharity, uint256 currentRate) private pure returns (uint256, uint256, uint256) {
        ...
        uint256 totalTax = rFee.add(rBurn).add(rCharity);
    ...
    function _takeCharity(address sender, uint256 tCharity) private returns(uint256){
      ...
      emit Transfer(sender, _charityWalletAddress, rCharity);
      return rCharity;
    }
    ...
    function _burn(address account, uint256 amount) internal
    {
        ...
        _rOwned[_blackholeDead] = _rOwned[_blackholeDead].add(rBurn);
        _tBurnTotal = _tBurnTotal.add(amount);
        emit Transfer(account, _blackholeDead, amount);
    }
