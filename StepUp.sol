...
contract StepUp is ERC20 {
    using SafeMath for uint256;
    using Address for address;
    uint256 public constant maxSupply = 10**9 * 10**18;
    IUniswapV2Router02 public uniswapV2Router;
    address public uniswapV2Pair;
    uint256 public constant marketingSellFee = 5; 
    ...
    address public constant marketingAddress = 0x5eD7d5cF03A6BAde1867647fAd3AB29721A0A513; // Marketing Wallet
    bool public taxStatus = true;
    mapping(address => bool) public excludeFee;

    constructor() ERC20(maxSupply) {
