...
contract METABULLRAGE is Context, IERC20, Ownable {
    ...
    string private _name = "METABULLRAGE";
    string private _symbol = "BERAGE";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 1 * 10**9 * 10**_decimals;
    
    address payable public marketingAddress = payable(0xBBfc06D17FEEA894868b15e7ac8062b417ff2804);
    ...
    constructor () {
        ...
        _liquifyThreshhold = 20 * 10**4 * 10**_decimals;
